<x-slot:subtitle>Configura los tipos de membresía y sus períodos</x-slot:subtitle>
                    ...
                    <div class="p-6 border-b border-gray-200">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-sm text-gray-500">{{ $type->periods->count() }} {{ $type->periods->count() === 1 ? 'período' : 'períodos' }}</p>
                            </div>
                            <div class="flex items-center gap-2">
                                <flux:button class="border !text-indigo-600 hover:!bg-indigo-50 hover:!text-indigo-700" size="sm" variant="ghost" wire:click="editType({{ $type->id }})" icon="pencil">
                                    Editar
                                </flux:button>
                    ...
                    <div class="p-6">
                                    ...
                                    <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                        ...
                                        <div class="flex items-center gap-1 ml-4">
                                            ...
                                            {{-- <flux:button
                                                ...
                                                wire:confirm="¿Estás seguro de eliminar este período?"
                                                icon="trash"
                        ...
                        @else
                            <div class="text-center py-8">
                                ...
                                <p class="text-sm text-gray-500 mb-3">No hay períodos configurados</p>
                            </div>
                        @endif
                        ...
                        <flux:button
                            variant="outline"
                            icon="plus"
                            wire:click="createPeriod({{ $type->id }})"
                            class="w-full"
                        >
                            Agregar Período
                        </flux:button>
                ...
                <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg" wire:click.stop>
                        ...
                        <div class="px-6 py-4 space-y-4">
                            <!-- Nombre del período -->
                            <flux:field>
                                <flux:label for="periodName">Nombre del período *</flux:label>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <flux:field>
                                    ...
                                    <flux:input wire:model="durationValue" id="durationValue" type="number" min="1" placeholder="1" />
