            ...
            <div class="px-6 py-6">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                  <h4 class="text-sm font-semibold text-gray-700 mb-3">Información Personal</h4>
                  <div class="space-y-2">
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                  <h4 class="text-sm font-semibold text-gray-700 mb-3">Estado de Membresía</h4>
                  <div class="space-y-2">
                    <div class="flex justify-between">
                      <span class="text-sm text-gray-600">Membresías totales:</span>
                      <span class="text-sm font-medium text-gray-900">{{ $member->memberships->count() }}</span>
                    </div>
                    <div class="flex justify-between">
                      <span class="text-sm text-gray-600">Tipo actual:</span>
                      <span class="text-sm font-medium text-gray-900">
