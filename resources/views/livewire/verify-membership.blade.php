    ...
    <div class="fixed inset-0 bg-gray-900/50 backdrop-blur-sm transition-opacity z-50" wire:click="close"
      ...
      <div class="fixed inset-0 z-50 overflow-y-auto">
        <div class="flex min-h-full items-center justify-center p-4">
          <div
            class="transform overflow-hidden rounded-xl bg-white dark:bg-zinc-900 text-left shadow-2xl transition-all w-full max-w-6xl"
            wire:click.stop>
            @if ($member)
              <div class="grid grid-cols-1 md:grid-cols-12 bg-white dark:bg-zinc-900 min-h-[580px]">
                {{-- Left Column: Large Image --}}
                <div
                  class="md:col-span-6 relative bg-gray-100 dark:bg-zinc-800 flex items-center justify-center overflow-hidden">
                  @if ($member->photo)
                  ...
                  @else
                    <div class="flex flex-col items-center justify-center text-gray-400 p-8 text-center">
                      <div
                        class="w-32 h-32 bg-gray-200 dark:bg-zinc-700 rounded-full flex items-center justify-center mb-4">
                        <span
                          class="text-5xl font-bold text-gray-400 dark:text-zinc-500">{{ $member->initials() }}</span>
                      </div>
                    </div>
                  @endif
                ...
                <div
                  ...
                  <div>
                    ...
                    <div class="space-y-6">
                      @if ($status === 'active')
                        <div
                          class="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full bg-green-100 text-green-800 border border-green-200">
